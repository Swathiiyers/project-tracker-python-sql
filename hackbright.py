...
def make_new_student(first_name, last_name, github):
    ...
    QUERY = """
        ...
        """
#assigning the parameters passed from handle_input to variables of sql query
...
def get_grade_by_github_title(github, title):
    ...
    print "{github}'s grade for the project {title} is {grade}.".format(
            github=github, title=title, grade=grade[0])
...
#assigning the parameters passed from handle_input to variables of sql query
    ...
    print "Successfully added student: {github} and grade: {grade}".format(
        github=github, grade=grade)
